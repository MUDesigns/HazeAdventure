var PlayerEntity = me.ObjectEntity.extend({
    ...
    update: function() {
        ...
        if(me.input.isKeyPressed('restart')) { this.gameOver() }
        return false;
    },
    gameOver: function() {
...
var CoinEntity = me.CollectableEntity.extend({
    ...
    onCollision: function(res, obj) {
        ...
        me.game.remove(this);
        document.getElementById('game-state').innerHTML = `Coins: ${me.gamestat.getItemValue("coins")}/${me.gamestat.getItemValue("totalCoins")}`;
...
var EnemyEntity2 = me.ObjectEntity.extend({
    ...
    onCollision: function(res, obj) {
        ...
        me.gamestat.updateValue("coins", -1)
        this.collidable = false;
        document.getElementById('instructions').innerHTML = "The red enemy took one of your coins. Press 'R' to restart";
        }
        document.getElementById('game-state').innerHTML = `Coins: ${me.gamestat.getItemValue("coins")}/${me.gamestat.getItemValue("totalCoins")}`;
    },
    update: function() {
